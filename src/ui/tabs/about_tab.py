...
class AboutTab:
    ...
    def _create_widgets(self) -> None:
        ...
        # Repository
        repo_frame = tk.Frame(scrollable_frame, bg=BG_COLOR)
        repo_frame.pack(anchor="w", pady=(0, 12))

        self.repo_lbl = tk.Label(
            repo_frame,
            text=t("about.repository", "Репозиторий программы: "),
            fg=FG_COLOR,
            bg=BG_COLOR,
            font=("Segoe UI", 10),
        )
        ...
        url_repo = "https://github.com/RandomNameQ/PathOfQuality"
        ...
        self.repo_link.pack(side="left")
        self.repo_link.bind("<Button-1>", lambda e: webbrowser.open(url_repo))
        self.tt_repo = ToolTip(self.repo_link, text=url_repo)
        ...
        self.tg_lbl = tk.Label(
            tg_frame,
            text=t("about.telegram", "Для связи используйте телеграм "),
            fg=FG_COLOR,
            bg=BG_COLOR,
            font=("Segoe UI", 10),
        )
        ...
        self.text2 = tk.Label(
            ...
            text=t(
                "about.support",
                "Для поддержки текущих и будущих проектов можете донатить на:",
            ),
            fg=FG_COLOR,
            bg=BG_COLOR,
            font=("Segoe UI", 10),
        ...
        # Crypto
        self.crypto_lbl = tk.Label(
            scrollable_frame,
            text=t("about.crypto", "Криптовалюта"),
            fg=FG_COLOR,
            bg=BG_COLOR,
            font=("Segoe UI", 10, "bold"),
        )
        ...
        self._add_crypto(
            scrollable_frame, "TON", "UQBYbeE_Y27_11-MSFqO4Udr-YAihHuAEznyCQ5EHhevR71R"
        )
        self._add_crypto(
            scrollable_frame, "BTC", "bc1qvtsc8p7stzpj88hyhd2z45ps5q62auxceztmxf"
        )
        self._add_crypto(
            scrollable_frame, "ETH", "0x17e06f02FA09B5E1314e46B775d2825B480a57f5"
        )
    ...
    def refresh_texts(self) -> None:
        ...
        if hasattr(self, "repo_lbl"):
            self.repo_lbl.config(text=t("about.repository", "Репозиторий программы: "))
